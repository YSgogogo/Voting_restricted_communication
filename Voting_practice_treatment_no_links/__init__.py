...
doc = """
Voting_practice_treatment__no_links
"""


class C(BaseConstants):
    NAME_IN_URL = 'Voting_practice_treatment_no_links'
    PLAYERS_PER_GROUP = 5
    NUM_ROUNDS = 5
...
page_sequence = [StartRoundWaitPage, Welcome, General_Instructions, Main_Instructions, Practice, ResultsWaitPage1, Info_and_decision, network_and_voting, ResultsWaitPage3, ResultsWaitPage4, ResultsWaitPage5, Results]
